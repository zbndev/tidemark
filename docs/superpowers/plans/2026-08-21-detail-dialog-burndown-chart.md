...
- [x] **Step 1: Add a failing storage test for the open segment only**
...
- [x] **Step 2: Run the focused storage test and observe the missing method**
...
- [x] **Step 3: Implement the smallest storage query**
...
- [x] **Step 5: Add the failing shared-wire round-trip test**
...
- [x] **Step 6: Run the wire test and observe the missing type**
...
- [x] **Step 7: Add and export the D-Bus dictionary**
...
- [x] **Step 8: Run the affected crate tests and commit**
...
- [x] **Step 1: Add a failing engine command test**
...
- [x] **Step 2: Run the focused engine test and observe the missing command**
...
- [x] **Step 3: Add the serialized engine query**
...
- [x] **Step 4: Run the engine test to green**

  Run: `cargo test -p tidemarkd engine::tests::current_segment -- --nocapture`

  Expected: current segment and unknown-account assertions pass.

- [x] **Step 5: Add failing service and proxy contract tests**
...
- [x] **Step 6: Run the focused service test and observe the missing method**
...
- [x] **Step 7: Implement the D-Bus method and proxy declaration**
...
- [x] **Step 8: Run daemon and client tests, then commit**
...
- [x] **Step 4: Run the geometry test suite to green**

  Run: `cargo test -p tidemark chart::tests -- --nocapture`

  Expected: all deterministic geometry cases pass without a display server.

- [x] **Step 5: Add the drawing widget after geometry is green**
...
- [x] **Step 6: Register the module and run GUI tests**

  Add `mod chart;` in `main.rs` and run:

  `cargo test -p tidemark`

- [x] **Step 7: Commit the isolated chart boundary**
...
- [x] **Step 2: Run the focused tests and observe the missing detail module**

  Run: `cargo test -p tidemark detail::tests:: -- --nocapture`

  Expected: compilation failure because `detail` is not declared.

- [x] **Step 3: Implement selection model and dialog layout**
...
- [x] **Step 4: Protect asynchronous requests and test it**
...
- [x] **Step 5: Add failing card activation and dialog-slot tests**
...
- [x] **Step 6: Make cards activatable and wire `MainWindow` ownership**
...
- [x] **Step 7: Run the focused GUI suite**
...
- [x] **Step 2: Build and install the working tree**
...
- [x] **Step 3: Record the outcome and commit documentation**
